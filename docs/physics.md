...
*Figure 1: W&B trace showing the agent cutting the furnace temperature (blue line) long before the target radius (green line) is reached, allowing the material temperature (red line) to drift safely into the target zone.*
